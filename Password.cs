...
namespace WindowsFormsApplication1
{
    public partial class Password : Form
    {
        ...
        {
            Button1.BackgroundImage = Image.FromFile(@"Image\capturedimage4.jpg");
            Button2.BackgroundImage = Image.FromFile(@"Image\capturedimage1.jpg");
            Button3.BackgroundImage = Image.FromFile(@"Image\capturedimage2.jpg");
            Button4.BackgroundImage = Image.FromFile(@"Image\capturedimage3.jpg");
            ...
            Button7.BackgroundImage = Image.FromFile(@"Image\capturedimage9.jpg");
            Button8.BackgroundImage = Image.FromFile(@"Image\capturedimage8.jpg");
            Button9.BackgroundImage = Image.FromFile(@"Image\capturedimage7.jpg");
        }
