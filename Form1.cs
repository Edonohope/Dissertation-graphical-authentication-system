	...
	public partial class Form1 : Form
	{
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (newpass2.status == "Edit")
            {
                ...
                string s = "select pass from LoginTbl where  emailid ='" +id + "'";
                ...
                string s1 = "select pattern from Rgb where  emailid ='" + id + "'";
                da1 = new SqlDataAdapter(s1, con);
                da1.Fill(ds1);
                if (ds1.Tables[0].Rows.Count > 0)
                {
                    val1 = ds1.Tables[0].Rows[0][0].ToString();
                }

               
                
                    this.Close();
                    Maincs ms = new Maincs();
                    ms.Show();
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("Insert into Img values('" + s + "','123456789','" + adminSetLogin.emailid + "')", con);
                    cmd.ExecuteNonQuery();
